<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryRef" :inline="true" v-show="showSearch">
      <el-form-item label="培训计划ID" prop="planId"><el-input v-model="queryParams.planId" placeholder="计划ID" clearable style="width:120px" /></el-form-item>
    ...
    <el-table v-loading="loading" :data="resultList" border size="small">
      ...
      <el-table-column label="成绩" prop="examScore" width="80" align="right" />
      ...
      <el-table-column label="合格" prop="passStatus" width="80" align="center">
        <template #default="scope"><el-tag :type="scope.row.passStatus === '1' ? 'success' : 'danger'" size="small">{{ scope.row.passStatus === '1' ? '合格' : '不合格' }}</el-tag></template>
      </el-table-column>
...
import { listTrainingResult, getTrainingResult, addTrainingResult, updateTrainingResult } from '@/api/teacher/training'
